...
class UserSelection {
    ...
    toggleProviderHint() {
        ...
        // Only show hint for providers that require API keys (xai, openai)
        if (selectedProvider === 'xai' || selectedProvider === 'openai') {
    ...
    async collectFormData() {
        ...
        if (providerName) eidoData['PROVIDER_NAME'] = providerName;
