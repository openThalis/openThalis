...
from src.disk.users import models
...
async def delete_user(email: str):
    async with AsyncSessionLocal() as session:
        ...
        from src.disk.services.chats import models as chat_models
        from src.disk.services.settings import models as settings_models
        from src.disk.services.eido import models as eido_models
        from src.disk.services.tasks import models as task_models
        from src.disk.services.aether import models as aether_models
