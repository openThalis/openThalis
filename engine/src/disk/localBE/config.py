...
try:
    from src.disk.pythonDB.core.db import AsyncSessionLocal  # type: ignore
    from src.disk.pythonDB.services.settings import models as settings_models  # type: ignore
except Exception:
